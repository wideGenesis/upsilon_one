...
class XYChart(BaseChart) :
	...
	def getYValue(self, yCoor, yAxis = None) :
		return _r("XYChart.getYValue", self.this, yCoor, decodePtr(yAxis))
...
class ThreeDScatterGroup(AutoMethod) :
	...
	def setDataSymbol3(self, image) :
		_r("ThreeDScatterGroup.setDataSymbol3", self.this, image.this)
...
class ThreeDScatterChart(ThreeDChart) :
	...
	def __init__(self, width, height, bgColor = BackgroundColor, edgeColor = Transparent, raisedEffect = 0) :
		self.this = _r("ThreeDScatterChart.create", width, height, bgColor, edgeColor, raisedEffect)
