...
c.addScatterLayer(dataX0, dataY0, "Technology AAA", GlassSphere2Shape, 15, 0xff3333).setSymbolScale(
    dataZ0)
...
c.addScatterLayer(dataX1, dataY1, "Technology BBB", GlassSphere2Shape, 15, 0x0000ff).setSymbolScale(
    dataZ1)
