...
data = [3.0, 2.8, 4.0, 5.5, 7.5, 6.8, 5.4, 6.0, 5.0, 6.2, 7.5, 6.5, 7.5, 8.1, 6.0, 5.5, 5.3, 3.5,
    5.0, 6.6, 5.6, 4.8, 5.2, 6.5, 6.2]
...
c.addTitle("Snow Percipitation (Dec 12)", "arialbd.ttf", 10).setBackground(c.patternColor([0xb0b0f0,
    0xe0e0ff], 2), 0x000000)
