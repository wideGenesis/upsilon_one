...
c = XYChart(600, 480, 0xccccff, 0x000000, 1)

# Add a title box to the chart using 16pt Arial Bold Italic font, with white text on deep blue
# background
c.addTitle("Four Quadrant Chart Demonstration", "arialbi.ttf", 16, 0xffffff).setBackground(0x000080)
...
# Bold font.
legendBox = c.addLegend(300, 460, 0, "arialbd.ttf", 8)
