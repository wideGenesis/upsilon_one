...
data = [42, 49, 33, 38, 51, 46, 29, 41, 44, 57, 59, 52, 37, 34, 51, 56, 56, 60, 70, 76, 63, 67, 75,
    64, 51]
errData = [5, 6, 5.1, 6.5, 6.6, 8, 5.4, 5.1, 4.6, 5.0, 5.2, 6.0, 4.9, 5.6, 4.8, 6.2, 7.4, 7.1, 6.0,
    6.6, 7.1, 5.3, 5.5, 7.9, 6.1]
...
errLayer = c.addBoxWhiskerLayer(None, None, ArrayMath(data).add(errData).result(), ArrayMath(data
    ).sub(errData).result(), data, Transparent, 0xbb6633)
