...
c.setPlotArea(50, 50, 500, 200, 0xffffff, 0xf8f8f8, Transparent, c.dashLineColor(0xcccccc, DotLine),
    c.dashLineColor(0xcccccc, DotLine))

# Add a legend box at (50, 22) using horizontal layout. Use 10 pt Arial Bold Italic font, with
# transparent background
c.addLegend(50, 22, 0, "arialbi.ttf", 10).setBackground(Transparent)
