...
c.addTitle("Polar Area Chart Demo", "arialbi.ttf", 15).setBackground(c.patternColor(os.path.join(
    os.path.dirname(sys.argv[0]), "wood.png")))
...
b = c.addLegend(230, 35, 0, "arialbd.ttf", 9)
