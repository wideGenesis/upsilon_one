...
if chartIndex % 2 == 0 :
    ...
    t = m.addText(240, labelYPos[chartIndex], m.formatValue(value, "2"), "arial.ttf", 8, 0xffffff,
        Right)
    ...
    # on a black (0x000000) background with depressed rounded border.
    t = m.addText(18, labelYPos[chartIndex], m.formatValue(value, "2"), "arial.ttf", 8, 0xffffff,
        Left)
    t.setBackground(0x000000, 0x000000, -1)
    t.setRoundedCorners(3)
