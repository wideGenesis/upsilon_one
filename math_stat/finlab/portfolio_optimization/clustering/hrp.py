...
# from math_stat.finlab.portfolio_optimization.utils import risk_metrics as RiskMetrics
# from math_stat.finlab.portfolio_optimization.estimators import risk_estimators as ReturnsEstimators
        ...
        while clustered_alphas:
            ...
            for subcluster in range(0, len(clustered_alphas), 2):
                ...
                if np.isnan(alloc_factor):
                    print("NaNs encountered while calculating allocation factor. Replacing it with equal weighting allocation scheme.")
                    alloc_factor = 0.5
